...
// System calls
// This enumeration gives every system call a unique syscall number
// They are exposed to processes in syslib.h (i.e. yield())
// They are exposed to kernel/threads in scheduler.h (i.e. do_yield())
typedef enum {
    SYSCALL_YIELD=0,
    SYSCALL_EXIT,
    SYSCALL_GETPID,
